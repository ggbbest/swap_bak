...
import { ERC20, ICroDefiSwapPairInterface } from './abis/CroDefiSwapAbi'
...
export abstract class Fetcher {
  ...
  public static async fetchPairData(
    ...
    const [reserves0, reserves1] = await new Contract(address, ICroDefiSwapPairInterface.abi, provider).getReserves()
